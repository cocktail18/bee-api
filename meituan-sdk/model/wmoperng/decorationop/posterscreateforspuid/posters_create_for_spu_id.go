...
const posters_create_for_spu_id_url = "/wmoper/ng/decorationop/postersCreateForSpuId"
...
func (req *PostersCreateForSpuIdRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*PostersCreateForSpuIdResponse, error) {
    resp, err := client.InvokeApi(posters_create_for_spu_id_url, 16, appAuthToken, req)
