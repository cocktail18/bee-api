...
const special_food_bind_spu_and_sku_code_url = "/wmoper/ng/special/food/bindSpuAndSkuCode"
...
func (req *SpecialFoodBindSpuAndSkuCodeRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*SpecialFoodBindSpuAndSkuCodeResponse, error) {
    resp, err := client.InvokeApi(special_food_bind_spu_and_sku_code_url, 16, appAuthToken, req)
