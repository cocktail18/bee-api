...
const shipping_save_url = "/wmoper/ng/shippingop/save"
...
func (req *ShippingSaveRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*ShippingSaveResponse, error) {
    resp, err := client.InvokeApi(shipping_save_url, 16, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response ShippingSaveResponse
