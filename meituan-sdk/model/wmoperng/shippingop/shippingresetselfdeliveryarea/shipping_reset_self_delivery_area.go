...
const shipping_reset_self_delivery_area_url = "/wmoper/ng/shippingop/resetSelfDeliveryArea"
...
func (req *ShippingResetSelfDeliveryAreaRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*ShippingResetSelfDeliveryAreaResponse, error) {
    resp, err := client.InvokeApi(shipping_reset_self_delivery_area_url, 16, appAuthToken, req)
