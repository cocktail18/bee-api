...
const food_update_appfoodcode_by_name_and_spec_url = "/wmoper/ng/foodop/food/updateAppFoodCodeByNameAndSpec"
...
type FoodUpdateAppfoodcodeByNameAndSpecRequest struct {
    ...
    */
    ...
    /**
    *  新sku_id，为商品sku的唯一标示,如商品有规格，则必填 
    */
...
func (req *FoodUpdateAppfoodcodeByNameAndSpecRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*FoodUpdateAppfoodcodeByNameAndSpecResponse, error) {
    resp, err := client.InvokeApi(food_update_appfoodcode_by_name_and_spec_url, 16, appAuthToken, req)
