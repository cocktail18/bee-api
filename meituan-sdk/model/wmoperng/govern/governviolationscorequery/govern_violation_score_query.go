...
const govern_violation_score_query_url = "/wmoper/ng/govern/violation/score/query"
...
func (req *GovernViolationScoreQueryRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GovernViolationScoreQueryResponse, error) {
    resp, err := client.InvokeApi(govern_violation_score_query_url, 16, appAuthToken, req)
