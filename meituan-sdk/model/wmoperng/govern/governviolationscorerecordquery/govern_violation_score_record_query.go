...
const govern_violation_score_record_query_url = "/wmoper/ng/govern/violation/score/record/query"
...
type GovernViolationScoreRecordQueryRequest struct {
    ...
    */
    ...
    /**
    *  违规类型 1-一般违规 51-严重违规 0-同时包含一般和严重违规 
    */
...
func (req *GovernViolationScoreRecordQueryRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GovernViolationScoreRecordQueryResponse, error) {
    resp, err := client.InvokeApi(govern_violation_score_record_query_url, 16, appAuthToken, req)
