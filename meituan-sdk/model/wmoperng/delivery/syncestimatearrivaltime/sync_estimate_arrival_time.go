...
const sync_estimate_arrival_time_url = "/wmoper/ng/delivery/medicine/syncEstimateArrivalTime"
...
func (req *SyncEstimateArrivalTimeRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*SyncEstimateArrivalTimeResponse, error) {
    resp, err := client.InvokeApi(sync_estimate_arrival_time_url, 16, appAuthToken, req)
