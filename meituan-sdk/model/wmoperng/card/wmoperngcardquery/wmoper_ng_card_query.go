...
const wmoper_ng_card_query_url = "/wmoper/ng/card/queryCard"
...
type QueryCardResp struct {
    ...
    */
    ...
    UpgradeDetailList []UpdateDetailVOList `json:"upgradeDetailList"`
    /**
...
type WmoperNgCardQueryResponse struct {
    Code string `json:"code"`
    Msg string `json:"msg"`
    Data QueryCardResp `json:"data"`
...
type WmoperNgCardQueryRequest struct {
}
...
type UpdateDetailVOList struct {
    /**
...
func (req *WmoperNgCardQueryRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*WmoperNgCardQueryResponse, error) {
    resp, err := client.InvokeApi(wmoper_ng_card_query_url, 16, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response WmoperNgCardQueryResponse
...
func (response *WmoperNgCardQueryResponse) IsSuccess() bool {
