...
const wmoper_card_query_url = "/wmoper/card/queryCard"
...
type WmoperCardQueryData struct {
    /**
    * 安心卡id
    */
...
type WmoperCardQueryRequest struct {
}
...
type WmoperCardQueryResponse struct {
    Code string `json:"code"`
    Msg string `json:"msg"`
    Data WmoperCardQueryData `json:"data"`
    TraceId string `json:"traceId"`
}



func (req *WmoperCardQueryRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*WmoperCardQueryResponse, error) {
    resp, err := client.InvokeApi(wmoper_card_query_url, 16, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response WmoperCardQueryResponse
...
func (response *WmoperCardQueryResponse) IsSuccess() bool {
