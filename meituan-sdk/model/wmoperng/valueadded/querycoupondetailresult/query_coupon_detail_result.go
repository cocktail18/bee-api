...
const query_coupon_detail_result_url = "/wmoper/ng/valueadded/queryCouponDetailResult"
...
func (req *QueryCouponDetailResultRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*QueryCouponDetailResultResponse, error) {
    resp, err := client.InvokeApi(query_coupon_detail_result_url, 16, appAuthToken, req)
