...
const query_coupon_total_result_url = "/wmoper/ng/valueadded/queryCouponTotalResult"
...
func (req *QueryCouponTotalResultRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*QueryCouponTotalResultResponse, error) {
    resp, err := client.InvokeApi(query_coupon_total_result_url, 16, appAuthToken, req)
