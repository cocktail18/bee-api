...
const query_coupon_detail_extra_result_url = "/wmoper/ng/valueadded/queryCouponDetailExtraResult"
...
func (req *QueryCouponDetailExtraResultRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*QueryCouponDetailExtraResultResponse, error) {
    resp, err := client.InvokeApi(query_coupon_detail_extra_result_url, 16, appAuthToken, req)
