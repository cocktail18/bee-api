...
const get_poi_score_detail_url = "/wmoper/ng/poi/getPoiScoreDetail"
...
type ExtraFields struct {
    HoverTextPcUrl string `json:"hoverTextPcUrl"`
    HoverBold string `json:"hoverBold"`
    /**
    * hover文本描述
    */
    HoverText string `json:"hoverText"`
    HoverTextAppUrl string `json:"hoverTextAppUrl"`
    /**
    * 占比
    */
...
func (req *GetPoiScoreDetailRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GetPoiScoreDetailResponse, error) {
    resp, err := client.InvokeApi(get_poi_score_detail_url, 16, appAuthToken, req)
