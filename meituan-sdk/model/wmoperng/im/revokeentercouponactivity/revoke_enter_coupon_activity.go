...
const revoke_enter_coupon_activity_url = "/wmoper/ng/im/revokeEnterCouponActivity"
...
func (req *RevokeEnterCouponActivityRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*RevokeEnterCouponActivityResponse, error) {
    resp, err := client.InvokeApi(revoke_enter_coupon_activity_url, 16, appAuthToken, req)
