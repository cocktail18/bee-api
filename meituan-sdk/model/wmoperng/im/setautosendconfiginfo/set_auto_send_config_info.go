...
const set_auto_send_config_info_url = "/wmoper/ng/im/autosend/setAutoSendConfigInfo"
...
func (req *SetAutoSendConfigInfoRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*SetAutoSendConfigInfoResponse, error) {
    resp, err := client.InvokeApi(set_auto_send_config_info_url, 16, appAuthToken, req)
