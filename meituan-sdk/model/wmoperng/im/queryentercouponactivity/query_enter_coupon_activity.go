...
const query_enter_coupon_activity_url = "/wmoper/ng/im/queryEnterCouponActivity"
...
func (req *QueryEnterCouponActivityRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*QueryEnterCouponActivityResponse, error) {
    resp, err := client.InvokeApi(query_enter_coupon_activity_url, 16, appAuthToken, req)
