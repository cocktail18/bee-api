...
const get_auto_send_config_info_url = "/wmoper/ng/im/autosend/getAutoSendConfigInfo"
...
func (req *GetAutoSendConfigInfoRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GetAutoSendConfigInfoResponse, error) {
    resp, err := client.InvokeApi(get_auto_send_config_info_url, 16, appAuthToken, req)
