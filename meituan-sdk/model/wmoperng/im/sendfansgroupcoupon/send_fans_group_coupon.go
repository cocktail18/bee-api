...
const send_fans_group_coupon_url = "/wmoper/ng/im/sendFansGroupCoupon"
...
type SendFansGroupCouponRequest struct {
    ...
    *  三方商品ID 商品券必传 
    */
    AppFoodCode int32 `json:"app_food_code"`
    /**
...
func (req *SendFansGroupCouponRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*SendFansGroupCouponResponse, error) {
    resp, err := client.InvokeApi(send_fans_group_coupon_url, 16, appAuthToken, req)
