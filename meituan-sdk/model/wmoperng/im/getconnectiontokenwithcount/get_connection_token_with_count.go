...
const get_connection_token_with_count_url = "/wmoper/ng/im/getConnectionTokenWithCount"
...
func (req *GetConnectionTokenWithCountRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GetConnectionTokenWithCountResponse, error) {
    resp, err := client.InvokeApi(get_connection_token_with_count_url, 16, appAuthToken, req)
