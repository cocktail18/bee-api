...
const create_enter_coupon_activity_url = "/wmoper/ng/im/createEnterCouponActivity"
...
func (req *CreateEnterCouponActivityRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*CreateEnterCouponActivityResponse, error) {
    resp, err := client.InvokeApi(create_enter_coupon_activity_url, 16, appAuthToken, req)
