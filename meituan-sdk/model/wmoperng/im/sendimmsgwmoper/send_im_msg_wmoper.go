...
const send_im_msg_wmoper_url = "/wmoper/ng/im/msg/send"

type SendImMsgWmoperResponse struct {
    Code string `json:"code"`
    Msg string `json:"msg"`
    TraceId string `json:"traceId"`
}
type SendImMsgWmoperRequest struct {
    /**
...
func (req *SendImMsgWmoperRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*SendImMsgWmoperResponse, error) {
    resp, err := client.InvokeApi(send_im_msg_wmoper_url, 16, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response SendImMsgWmoperResponse
...
func (response *SendImMsgWmoperResponse) IsSuccess() bool {
