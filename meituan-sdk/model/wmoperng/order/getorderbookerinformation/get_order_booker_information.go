...
const get_order_booker_information_url = "/wmoper/ng/order/getOrderBookerInformation"
...
func (req *GetOrderBookerInformationRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GetOrderBookerInformationResponse, error) {
    resp, err := client.InvokeApi(get_order_booker_information_url, 16, appAuthToken, req)
