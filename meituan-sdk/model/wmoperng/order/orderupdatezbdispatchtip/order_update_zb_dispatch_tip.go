...
const order_update_zb_dispatch_tip_url = "/wmoper/ng/order/updateZbDispatchTip"
...
func (req *OrderUpdateZbDispatchTipRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*OrderUpdateZbDispatchTipResponse, error) {
    resp, err := client.InvokeApi(order_update_zb_dispatch_tip_url, 16, appAuthToken, req)
