...
const get_batch_order_refund_info_url = "/wmoper/ng/order/getBatchOrderRefundInfo"
...
func (req *GetBatchOrderRefundInfoRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GetBatchOrderRefundInfoResponse, error) {
    resp, err := client.InvokeApi(get_batch_order_refund_info_url, 16, appAuthToken, req)
