...
const cancel_zb_logistics_by_wm_order_id_url = "/wmoper/ng/order/cancelZbLogisticsByWmOrderId"
...
func (req *CancelZbLogisticsByWmOrderIdRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*CancelZbLogisticsByWmOrderIdResponse, error) {
    resp, err := client.InvokeApi(cancel_zb_logistics_by_wm_order_id_url, 16, appAuthToken, req)
