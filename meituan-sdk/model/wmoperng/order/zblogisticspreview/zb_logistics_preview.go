...
const zb_logistics_preview_url = "/wmoper/ng/order/zbLogisticsPreview"
...
type ZbLogisticsPreviewRequest struct {
    ...
    */
    ...
    /**
    *  跑腿配送服务品牌 1003-美团跑腿经济送；2011-美团跑腿蛋糕送。 
    */
    LogisticsCode string `json:"logisticsCode"`
    /**
    *  当传递true时会返回对应可使用的权益列表。 
    */
    RecommendRights bool `json:"recommendRights"`
}
...
func (req *ZbLogisticsPreviewRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*ZbLogisticsPreviewResponse, error) {
    resp, err := client.InvokeApi(zb_logistics_preview_url, 16, appAuthToken, req)
