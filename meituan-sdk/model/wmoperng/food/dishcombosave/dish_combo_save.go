...
const dish_combo_save_url = "/wmoper/ng/food/combo/save"
...
func (req *DishComboSaveRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*DishComboSaveResponse, error) {
    resp, err := client.InvokeApi(dish_combo_save_url, 16, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response DishComboSaveResponse
