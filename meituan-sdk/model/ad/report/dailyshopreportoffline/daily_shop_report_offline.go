package dailyshopreportoffline
...
const daily_shop_report_offline_url = "/ad/report/getDailyDataByShopOffline"

type DailyShopReportOfflineResponse struct {
...
type DailyShopReportOfflineRequest struct {
    /**
    * 门店id列表,单次最多支持50个
    */
...
func (req *DailyShopReportOfflineRequest) DoInvoke(client mtclient.MeituanClient) (*DailyShopReportOfflineResponse, error) {
    resp, err := client.InvokeApi(daily_shop_report_offline_url, 22, "", req)

    if err != nil {
        return nil, err
    }
    var response DailyShopReportOfflineResponse
...
func (response *DailyShopReportOfflineResponse) IsSuccess() bool {
