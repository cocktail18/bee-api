...
const shopmenu_create_url = "/foodmop/sku/shopmenu/create"
...
type ShopmenuCreateResponse struct {
...
type ShopmenuCreateRequest struct {
    /**
    *  门店菜谱 
    */
...
type VendorShopMenuDTO struct {
    ...
    */
    ...
    /**
    *  是否更新商品的门店上下架状态 默认为true 
    */
    UpdateShelfStatus bool `json:"updateShelfStatus"`
}
...
func (req *ShopmenuCreateRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*ShopmenuCreateResponse, error) {
    resp, err := client.InvokeApi(shopmenu_create_url, 51, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response ShopmenuCreateResponse
...
func (response *ShopmenuCreateResponse) IsSuccess() bool {
