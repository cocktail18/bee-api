package waimaisaveboxpricetypeanddetail
...
const waimai_save_box_price_type_and_detail_url = "/waimai/ng/dish/saveBoxPriceTypeAndDetail"
...
type WaimaiSaveBoxPriceTypeAndDetailResponse struct {
    Code string `json:"code"`
    Msg string `json:"msg"`
    Data string `json:"data"`
    TraceId string `json:"traceId"`
}
type WaimaiSaveBoxPriceTypeAndDetailRequest struct {
    /**
...
func (req *WaimaiSaveBoxPriceTypeAndDetailRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*WaimaiSaveBoxPriceTypeAndDetailResponse, error) {
    resp, err := client.InvokeApi(waimai_save_box_price_type_and_detail_url, 2, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response WaimaiSaveBoxPriceTypeAndDetailResponse
