...
const food_query_list_url = "/waimai/ng/dish/queryFoodList"

type FoodQueryListRequest struct {
    /**
    *  分页查询偏移量 
    */
...
type FoodQueryListResponse struct {
...
func (req *FoodQueryListRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*FoodQueryListResponse, error) {
    resp, err := client.InvokeApi(food_query_list_url, 2, appAuthToken, req)

    if err != nil {
        return nil, err
    }
    var response FoodQueryListResponse
...
func (response *FoodQueryListResponse) IsSuccess() bool {
