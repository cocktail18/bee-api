...
const query_im_subscribe_status_by_epoi_url = "/waimai/ng/im/queryImSubscribeStatusByEpoi"
...
func (req *QueryImSubscribeStatusByEpoiRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*QueryImSubscribeStatusByEpoiResponse, error) {
    resp, err := client.InvokeApi(query_im_subscribe_status_by_epoi_url, 2, appAuthToken, req)
