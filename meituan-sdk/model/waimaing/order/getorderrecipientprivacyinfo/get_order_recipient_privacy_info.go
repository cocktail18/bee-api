...
const get_order_recipient_privacy_info_url = "/waimai/ng/order/getOrderRecipientPrivacyInfo"
...
func (req *GetOrderRecipientPrivacyInfoRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*GetOrderRecipientPrivacyInfoResponse, error) {
    resp, err := client.InvokeApi(get_order_recipient_privacy_info_url, 2, appAuthToken, req)
