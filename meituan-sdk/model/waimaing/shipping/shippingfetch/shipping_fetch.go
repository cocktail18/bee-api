...
const shipping_fetch_url = "/waimai/ng/shipping/fetch"

type ShippingAreaInfo struct {
    /**
    * 服务商方提供的配送范围id
    */
...
type ShippingFetchResponse struct {
    ...
    Msg string `json:"msg"`
    Data []ShippingAreaInfo `json:"data"`
...
func (req *ShippingFetchRequest) DoInvoke(client mtclient.MeituanClient, appAuthToken string) (*ShippingFetchResponse, error) {
    resp, err := client.InvokeApi(shipping_fetch_url, 2, appAuthToken, req)
