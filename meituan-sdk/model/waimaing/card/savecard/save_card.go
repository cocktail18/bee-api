...
const save_card_url = "/waimai/ng/card/save"
...
func (req *SaveCardRequest) DoInvoke(client mtclient.MeituanClient) (*SaveCardResponse, error) {
    resp, err := client.InvokeApi(save_card_url, 2, "", req)

    if err != nil {
        return nil, err
    }
    var response SaveCardResponse
...
func (response *SaveCardResponse) IsSuccess() bool {
