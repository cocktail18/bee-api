...
#同步代码
sync:
	cp -r web/src/plugin/* ../github/bee-simple-admin/web/src/plugin/
	cp -r server/plugin/* ../github/bee-simple-admin/server/plugin/
	cp -r bee-api/* ../github/bee-simple-admin/bee-api/
