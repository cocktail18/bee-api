...
type BeePayLog struct {
	...
	OrderNo    string            `gorm:"column:order_no;type:varchar(100);comment:order_no" json:"orderNo"`
	...
	Status     enum.PayLogStatus `gorm:"column:status;type:int(11);comment:status" json:"status"`
