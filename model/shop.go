...
type BeeShopInfo struct {
	...
	CyTablePayMod        int64              `gorm:"column:cy_table_pay_mod;type:bigint(11);comment:支付方式" json:"cyTablePayMod"`
	DistrictId           string             `gorm:"column:district_id;type:varchar(100);comment:唯一id" json:"districtId"`
	ExpressType          string             `gorm:"column:express_type;type:varchar(100);comment:快递类型" json:"expressType"`
	GoodsNeedCheck       bool               `gorm:"column:goods_need_check;type:tinyint(1);comment:商品需要检查" json:"goodsNeedCheck"`
	Latitude             float64            `gorm:"column:latitude;type:double(20,2);comment:纬度" json:"latitude"`
	LinkPhone            string             `gorm:"column:link_phone;type:varchar(100);comment:绑定手机" json:"linkPhone"`
	Longitude            float64            `gorm:"column:longitude;type:double(20,2);comment:经度" json:"longitude"`
	...
	OpenScan             bool               `gorm:"column:open_scan;type:tinyint(1);comment:开启扫描" json:"openScan"`
	...
	WorkStatus           int64              `gorm:"column:work_status;type:bigint(11);comment:营业状态" json:"workStatus"`
