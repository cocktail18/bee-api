  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateBeeUserBalanceLogFunc(scope.row)">变更</el-button>
...
<!--            </el-form-item>-->
            ...
            <el-form-item label="货币类型:"  prop="balanceType" >
              <el-select v-model="formData.balanceType" clearable placeholder="请选择" :clearable="false">
                <el-option v-for="(item,key) in balanceTypeMap" :key="key" :label="item.label" :value="parseInt(item.value)" />
              </el-select>
            </el-form-item>
            <el-form-item label="数量:"  prop="num" >
              <el-input-number v-model="formData.num"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
            <el-form-item label="用户id:"  prop="uid" >
...
const getTableData = async() => {
  const table = await getBeeUserBalanceLogList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
