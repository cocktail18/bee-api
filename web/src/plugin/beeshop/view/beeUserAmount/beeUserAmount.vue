<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="用户id" prop="uid" width="120" />
        <el-table-column sortable align="left" label="余额" prop="balance" width="120" />
        <el-table-column sortable align="left" label="冻结金额" prop="freeze" width="120" />
<!--        <el-table-column sortable align="left" label="佣金" prop="fxCommisionPaying" width="120" />-->
<!--        <el-table-column sortable align="left" label="成长值" prop="growth" width="120" />-->
        <el-table-column sortable align="left" label="积分" prop="score" width="120" />
<!--        <el-table-column sortable align="left" label="上一个周期的积分" prop="scoreLastRound" width="120" />-->
<!--        <el-table-column sortable align="left" label="支付总额" prop="totalPayAmount" width="120" />-->
<!--        <el-table-column sortable align="left" label="支付订单数" prop="totalPayNumber" width="120" />-->
<!--        <el-table-column sortable align="left" label="总积分" prop="totalScore" width="120" />-->
<!--        <el-table-column sortable align="left" label="撤回次数" prop="totalWithdraw" width="120" />-->
<!--        <el-table-column sortable align="left" label="累计消费金额" prop="totalConsumed" width="120" />-->
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateBeeUserAmountFunc(scope.row)">变更</el-button>
...
<!--            </el-form-item>-->
            ...
            <el-form-item label="冻结金额:"  prop="freeze" >
              <el-input-number v-model="formData.freeze"  style="width:100%" :precision="2" :clearable="true"  />
            </el-form-item>
<!--            <el-form-item label="佣金:"  prop="fxCommisionPaying" >-->
<!--              <el-input-number v-model="formData.fxCommisionPaying"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
<!--            <el-form-item label="成长值:"  prop="growth" >-->
<!--              <el-input-number v-model="formData.growth"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
...
<!--              <el-input-number v-model="formData.scoreLastRound"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
<!--            <el-form-item label="支付总额:"  prop="totalPayAmount" >-->
<!--              <el-input-number v-model="formData.totalPayAmount"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
<!--            <el-form-item label="支付订单数:"  prop="totalPayNumber" >-->
<!--              <el-input-number v-model="formData.totalPayNumber"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
<!--            <el-form-item label="总积分:"  prop="totalScore" >-->
<!--              <el-input-number v-model="formData.totalScore"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
<!--            <el-form-item label="撤回次数:"  prop="totalWithdraw" >-->
<!--              <el-input-number v-model="formData.totalWithdraw"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
<!--            <el-form-item label="累计消费金额:"  prop="totalConsumed" >-->
<!--              <el-input-number v-model="formData.totalConsumed"  style="width:100%" :precision="2" :clearable="true"  />-->
<!--            </el-form-item>-->
          </el-form>
    </el-drawer>
  </div>
...
import {
  createBeeUserAmount,
  deleteBeeUserAmount,
  deleteBeeUserAmountByIds,
  updateBeeUserAmount,
  findBeeUserAmount,
  getBeeUserAmountList
...
const sortChange = ({ prop, order }) => {
  const sortMap = {
            ...
            balance: 'balance',
            freeze: 'freeze',
            fxCommisionPaying: 'fx_commision_paying',
            growth: 'growth',
            score: 'score',
            scoreLastRound: 'score_last_round',
            totalPayAmount: 'total_pay_amount',
            totalPayNumber: 'total_pay_number',
...
const getTableData = async() => {
  const table = await getBeeUserAmountList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deleteBeeUserAmountByIds({ ids })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updateBeeUserAmountFunc = async(row) => {
    const res = await findBeeUserAmount({ id: row.id })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteBeeUserAmountFunc = async (row) => {
    const res = await deleteBeeUserAmount({ id: row.id })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
